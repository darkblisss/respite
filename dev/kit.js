...
PAGES.companions = () => h("div.page",
  ...
  h("div.grid-cards",
    ...
    compCard({ name: "Marshcat", iconName: "marshcat", price: 300, trait: "Reedstalker", traitVal: "+8% Harvesting XP",
      ...
      unlocks: [["Bond 5", "+2% Harvesting double yield"], ["Bond 10", "+25% Pulp found alongside fibre"], ["Bond 20", "Harvesting actions 5% quicker"], ["Rank III", "+3% Harvesting double yield"]] }),
...
PAGES.market = () => h("div.page",
  ...
  h("section.card.card-flush",
    ...
    h("div.listings", { role: "table", "aria-label": "Listings" },
      h("div.listing-head", { role: "row" }, h("span", "Item"), h("span.num", "Left"), h("span.num", "Each"), h("span", "Seller"), h("span")),
      LISTINGS.map((l) => h("div.listing", { role: "row", class: l.mine && "is-mine" },
        h("div.listing-item",
