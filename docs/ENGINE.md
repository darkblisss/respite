...
Predictable commands: `startSkill, stopSkill, startHunt, pullBack, setHide, pickClass, setSkin, walkPath, resetPath, enchant, convert, equip, unequip, unequipTool, moveItem, sellItem, salvage, useChest, repair, reorder, buyRemedy, buySmuggler, travel, claimBounty, hireAgent, deployAgent, buyCompanion, setCompanion`.
