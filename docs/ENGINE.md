...
Predictable commands: `startSkill, stopSkill, startHunt, pullBack, setHide, pickClass, setSkin, walkPath, resetPath, enchant, equip, unequip, unequipTool, moveItem, sellItem, salvage, useChest, repair, reorder, buyRemedy, buySmuggler, travel, claimBounty, hireAgent, deployAgent, buyCompanion, setCompanion`.
